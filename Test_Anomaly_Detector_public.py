...
AllTest_Video_Path = '/content/drive/My Drive/AnomalyDetectionCVPR2018/SampleVideos/Test/Testing_Normal_Videos_Anomaly/'
# AllTest_Video_Path contains C3D features (txt file)  of each video. Each file contains 32 features, each of 4096 dimensions.
Results_Path = '/content/drive/My Drive/AnomalyDetectionCVPR2018/Eval_Res/'
# Results_Path is the folder where you can save your results
Model_dir='/content/drive/My Drive/AnomalyDetectionCVPR2018/Trained_Models/TrainedModel_MIL_C3D/'
# Model_dir is the folder where we have placed our trained weights
weights_path = Model_dir + 'weightsAnomalyL1L2_1000'
